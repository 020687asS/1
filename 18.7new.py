...
print('''
        ...
        9. Добавить предмет
        10. Изменить предмет
        11.Вывести информацию об одном ученике
...
while True:
    ...
    if command == 1:
        ...
        print('9. Добавить название предмета')
        # считываем название предмета
        class_new = input('Введите название предмета: ')
        if class_new in classes:
            print('Этот предмет уже есть в списке')
        else:
        ...
        print('10. Изменить название предмета')
        # считываем название предмета
        ...
        if student in students_marks:
            ...
            for class_ in classes:
                ...
                marks_count = len(students_marks[student][class_])
                # выводим средний балл по предмету
                print(f'Cредний балл {class_} - {marks_sum // marks_count}')
        else:
